...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Метаданные динамические: меняются на ревиле, посадке, очистке и каждом
    // левел-апе. Промежуточный кэш между нами и краулером маркетплейса означает,
    // что тот честно перечитывает — и честно получает вчерашний ответ. Выигрыш
    // от кэша на коллекции в сотни токенов нулевой, а такой призрак ловить очень
    // дорого.
