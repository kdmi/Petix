...
const DEFAULTS = Object.freeze({
  ...
  POINTS_PER_PETIX: 1,
  NFT_DEMO_BIND_LEVEL: 1, // мин. уровень персонажа для заливки в NFT-слот (016; 1 = порог отключён)
  NFT_DEMO_MINT_LIMIT: 5, // лимит бесплатного минта слотов на кошелёк (инфо для фронта; on-chain лимит задаётся в контракте)
  NFT_DEMO_UNBIND_COST: 10000, // цена очистки капсулы (сжигание привязанного персонажа)
  NFT_DEMO_UNBIND_DELAY_MS: 3600000, // отсрочка сжигания: час на то, чтобы статус разошёлся по маркетплейсам
});
...
function validateConfigPatch(patch) {
  ...
  const numericKeys = [
    ...
    "NFT_DEMO_BIND_LEVEL",
    "NFT_DEMO_MINT_LIMIT",
    "NFT_DEMO_UNBIND_COST",
    "NFT_DEMO_UNBIND_DELAY_MS",
  ];
